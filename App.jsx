...
const SERVICES_EN = [
  ...
  "School / Daycare Clean",
  "Restaurant Clean",
  "Warehouse / Facility Clean",
  // Add-ons
  "Inside Refrigerator",
  "Inside Oven",
  "Inside Cabinets",
...
const SERVICES_ES = [
  ...
  "Limpieza de Airbnb / Renta Vacacional",
  // Comercial
  "Limpieza de Oficina",
  "Limpieza de Tienda",
  "Limpieza de Oficina Médica",
  "Limpieza de Escuela / Guardería",
  "Limpieza de Restaurante",
  "Limpieza de Bodega / Instalación",
  // Extras
  "Interior de Refrigerador",
  "Interior de Horno",
  "Interior de Gabinetes",
  "Ventanas Interiores",
  "Lavandería y Doblar Ropa",
  "Organización",
  "Limpieza de Alfombra",
  "Servicio de Desinfección",
  "Limpieza de Garage",
  "Limpieza de Patio / Balcón",
  "Otro Servicio",
];
...
const TRANSLATIONS = {
  en: {
    appName: "BrilloPro",
    tagline: "Manage Your Cleaners. Grow Your Business.",
    ...
    route: {
      ...
      remove: "Remove",
      stop: "Stop",
      loadToday: "Load Today's Route",
      noScheduled: "No clients scheduled for today.",
    ...
    clients: {
      ...
      weekly: "Weekly",
      biweeklyA: "Bi-Weekly (Week A)",
      biweeklyB: "Bi-Weekly (Week B)",
      oneTime: "One-Time / No Schedule",
      days: ["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],
      daysFull: ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],
      import: "📥 Import CSV",
      downloadTemplate: "📄 Download Template",
      importTitle: "Import Clients from CSV",
      importBlurb: "Upload a CSV file to add many clients at once. Download the template, fill in your clients in Excel or Google Sheets, save as CSV, then upload here.",
      ...
      supplies: "Supplies",
      suppliesTypes: ["We Provide", "Client Provides", "Both"],
      pets: "Pets in Home",
      petsTypes: ["No Pets", "Dog", "Cat", "Dog & Cat", "Other"],
      preferredCleaner: "Preferred Cleaner",
      locationType: "Location Type",
      locationTypes: ["Residential", "Commercial", "Airbnb / Rental"],
    ...
    invoices: {
      ...
      addLine: "+ Add Service Line",
      removeLine: "Remove",
      lineItems: "Service Lines",
      from: "From",
      to: "Bill To",
      ...
      emailInv: "✉️ Email",
      deleteInv: "Delete",
      confirmDelInv: "Delete this invoice?",
    },
    estimates: {
      title: "Estimates",
      ...
      approved: "Approved",
      pending: "Pending",
      convertConfirm: "Convert this estimate to an invoice?",
      converted: "✓ Estimate converted to invoice!",
      textEst: "📱 Text",
      emailEst: "✉️ Email",
      deleteEst: "Delete",
      confirmDelEst: "Delete this estimate?",
    },
    billing: {
      ...
      exportBlurb: "Download your invoices as a CSV file to import into QuickBooks, Wave, FreshBooks, Xero, or your accountant's software.",
      noData: "No data to export yet.",
      paymentsTitle: "Payment Methods Accepted",
      paymentsBlurb: "Select which payment methods you accept. These will appear on every invoice.",
      check: "Check",
      cash: "Cash",
      zelle: "Zelle",
      venmo: "Venmo",
      ...
      paymentHandle: "Handle/Number (e.g. @Yourname or phone)",
    ...
    access: {
      ...
      subtitle: "Enter your BrilloPro access code to get started.",
      placeholder: "",
      btn: "Unlock App",
      error: "Invalid access code. Please try again.",
      codes: ["BP-2025-LAUNCH", "BP-2025-BETA1", "BP-2025-BETA2"],
    },
    setup: {
      title: "Welcome to BrilloPro!",
      subtitle: "Let's set up your cleaning business. This info will appear on your invoices and estimates.",
      companyName: "Company Name",
      ownerName: "Your Name",
      ...
      skip: "Skip for now",
      payments: "Payment Methods You Accept",
    },
    pdf: "🖨️ Print/PDF",
    lang: "Español",
  },
  es: {
    appName: "BrilloPro",
    tagline: "Maneja Tu Equipo. Haz Brillar Tu Negocio.",
    ...
    route: {
      ...
      navigate: "Iniciar GPS",
      remove: "Eliminar",
      stop: "Parada",
      loadToday: "Cargar Ruta de Hoy",
      noScheduled: "No hay clientes programados para hoy.",
      clearRoute: "Borrar Ruta",
      optimize: "⚡ Optimizar Orden",
    ...
    clients: {
      ...
      schedule: "Horario de Limpieza",
      weekly: "Semanal",
      biweeklyA: "Quincenal (Semana A)",
      biweeklyB: "Quincenal (Semana B)",
      oneTime: "Una Vez / Sin Horario",
      days: ["Lun","Mar","Mié","Jue","Vie","Sáb","Dom"],
      daysFull: ["Lunes","Martes","Miércoles","Jueves","Viernes","Sábado","Domingo"],
      import: "📥 Importar CSV",
      downloadTemplate: "📄 Descargar Plantilla",
      importTitle: "Importar Clientes desde CSV",
      importBlurb: "Sube un archivo CSV para agregar muchos clientes. Descarga la plantilla, llena tus clientes en Excel, guarda como CSV y súbelo aquí.",
      importSuccess: "¡clientes importados!",
      importError: "No se pudo leer el archivo. Asegúrate que sea CSV.",
      schedHelp: "Horario: weekly, biweeklyA, biweeklyB, o oneTime. Días: Lun,Mié,Vie",
      access: "Acceso a la Casa",
      accessTypes: ["Llave", "Caja de Llaves", "Cliente Presente", "Código de Puerta"],
      lockboxCode: "Código de Caja (protegido con PIN)",
      supplies: "Suministros",
      suppliesTypes: ["Nosotros Proveemos", "Cliente Provee", "Ambos"],
      pets: "Mascotas en Casa",
      petsTypes: ["Sin Mascotas", "Perro", "Gato", "Perro y Gato", "Otro"],
      preferredCleaner: "Limpiador(a) Preferido(a)",
      locationType: "Tipo de Lugar",
      locationTypes: ["Residencial", "Comercial", "Airbnb / Renta"],
    ...
    invoices: {
      ...
      review: "Pedir Reseña",
      addLine: "+ Agregar Servicio",
      removeLine: "Quitar",
      lineItems: "Servicios",
      from: "De",
      to: "Para",
      setup: "Configura tu negocio en Ajustes para que aparezca en las facturas.",
      invoiceNum: "Factura #",
      textInv: "📱 Mensaje",
      emailInv: "✉️ Correo",
      deleteInv: "Eliminar",
      confirmDelInv: "¿Eliminar esta factura?",
    },
    estimates: {
      title: "Estimados",
      ...
      approved: "Aprobado",
      pending: "Pendiente",
      convertConfirm: "¿Convertir este estimado a factura?",
      converted: "✓ ¡Estimado convertido a factura!",
      textEst: "📱 Mensaje",
      emailEst: "✉️ Correo",
      deleteEst: "Eliminar",
      confirmDelEst: "¿Eliminar este estimado?",
    },
    billing: {
      ...
      saveSettings: "Guardar Información",
      saved: "¡Información guardada!",
      exportTitle: "Exportar para Contabilidad",
      exportBlurb: "Descarga tus facturas en CSV para importar a QuickBooks, Wave, FreshBooks, Xero o tu contador.",
      noData: "No hay datos para exportar todavía.",
      paymentsTitle: "Métodos de Pago Aceptados",
      paymentsBlurb: "Selecciona los métodos de pago que aceptas. Aparecerán en cada factura.",
      check: "Cheque",
      cash: "Efectivo",
      zelle: "Zelle",
      venmo: "Venmo",
      ...
      paymentHandle: "Usuario/Número (ej. @TuNombre o teléfono)",
      reviewTitle: "Link de Reseñas de Google",
      reviewBlurb: "Pega aquí el link de reseñas de tu Negocio en Google. Consíguelo en business.google.com.",
      reviewPlaceholder: "https://g.page/r/TU-CODIGO/review",
    },
    access: {
      title: "Ingresa tu Código",
      subtitle: "Ingresa tu código de acceso de BrilloPro para comenzar.",
      placeholder: "",
      btn: "Desbloquear App",
    ...
    setup: {
      title: "¡Bienvenido a BrilloPro!",
      subtitle: "Configura tu negocio de limpieza. Estos datos saldrán en tus facturas y estimados.",
      companyName: "Nombre del Negocio",
      ownerName: "Tu Nombre",
      ...
      payments: "Métodos de Pago que Aceptas",
    },
    pdf: "🖨️ Imprimir/PDF",
    lang: "English",
  },
...
const formatDate = (iso) => {
  ...
  const [y, m, d] = parts;
  const mo = parseInt(m, 10); const dy = parseInt(d, 10);
  if (isNaN(mo) || isNaN(dy)) return iso;
  return `${mo}/${dy}/${y}`;
};
...
const sendSMS = (phone, body) => {
  ...
  window.location.href = `sms:${p}?body=${encodeURIComponent(body)}`;
};
...
const printInvoice = (inv, company, t) => {
  ...
  const paymentsHtml = enabledPayments.length > 0 ? `
    <div style="margin-top:30px;padding:16px;background:#E0F2FE;border-radius:8px;border-left:4px solid #0EA5E9;">
      <div style="font-weight:bold;color:#0EA5E9;margin-bottom:8px;">${t.billing.paymentsTitle}:</div>
  ...
  const html = `<!DOCTYPE html><html><head><title>${t.invoices.invoiceNum} ${inv.id}</title><meta charset="UTF-8"></head>
    <body style="font-family:Arial,sans-serif;max-width:800px;margin:30px auto;padding:30px;color:#0F172A;">
      <div style="border-bottom:3px solid #0EA5E9;padding-bottom:20px;margin-bottom:30px;">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;">
          <div>
            <div style="font-size:28px;font-weight:800;color:#0EA5E9;">${company.companyName||"Your Company"}</div>
            ${company.ownerName?`<div style="color:#64748B;">${company.ownerName}</div>`:""}
            ${company.phone?`<div style="color:#64748B;">📞 ${company.phone}</div>`:""}
            ${company.email?`<div style="color:#64748B;">✉️ ${company.email}</div>`:""}
            ${company.address?`<div style="color:#64748B;">${company.address}</div>`:""}
            ${company.license?`<div style="color:#64748B;font-size:11px;">License: ${company.license}</div>`:""}
          </div>
          <div style="text-align:right;">
            <div style="font-size:24px;font-weight:800;">INVOICE</div>
            <div style="color:#64748B;">#${inv.id}</div>
            <div style="color:#64748B;">${formatDate(inv.date)}</div>
          </div>
        </div>
      </div>
      <div style="margin-bottom:24px;">
        <div style="font-size:12px;color:#64748B;font-weight:bold;">${t.invoices.to}:</div>
        <div style="font-size:18px;font-weight:bold;">${inv.client}</div>
      </div>
      <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
        <thead><tr style="background:#0EA5E9;color:white;"><th style="padding:10px;text-align:left;">${t.invoices.service}</th><th style="padding:10px;text-align:left;">${t.invoices.date}</th><th style="padding:10px;text-align:right;">${t.invoices.amount}</th></tr></thead>
        <tbody>${linesHtml}</tbody>
      </table>
      <div style="text-align:right;font-size:22px;font-weight:800;color:#0EA5E9;padding:14px;background:#E0F2FE;border-radius:8px;">${t.invoices.total}: $${parseFloat(inv.total||0).toFixed(2)}</div>
      <div style="margin-top:14px;text-align:right;font-size:14px;font-weight:600;color:${inv.status==='paid'?'#10B981':'#F59E0B'};">${inv.status==='paid'?t.invoices.paid.toUpperCase():t.invoices.pending.toUpperCase()}</div>
      ${paymentsHtml}
      <div style="margin-top:40px;padding-top:20px;border-top:1px solid #eee;text-align:center;color:#999;font-size:11px;">Generated by BrilloPro · © 2025 Avanza One LLC. All rights reserved.</div>
    </body></html>`;
...
const printEstimate = (est, company, t) => {
  ...
  const html = `<!DOCTYPE html><html><head><title>Estimate ${est.id}</title><meta charset="UTF-8"></head>
    <body style="font-family:Arial,sans-serif;max-width:800px;margin:30px auto;padding:30px;color:#0F172A;">
      <div style="border-bottom:3px solid #0EA5E9;padding-bottom:20px;margin-bottom:30px;">
        <div style="display:flex;justify-content:space-between;">
          ...
          <div style="text-align:right;">
            <div style="font-size:24px;font-weight:800;">${t.estimates.title.toUpperCase()}</div>
            <div style="color:#64748B;">#${est.id}</div>
            <div style="color:#64748B;">${formatDate(est.date)}</div>
          </div>
        </div>
      </div>
      <div style="margin-bottom:24px;"><div style="font-size:12px;color:#64748B;font-weight:bold;">${t.invoices.to}:</div><div style="font-size:18px;font-weight:bold;">${est.client}</div></div>
      <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
        <thead><tr style="background:#0EA5E9;color:white;"><th style="padding:10px;text-align:left;">Service</th><th style="padding:10px;text-align:right;">Amount</th></tr></thead>
        <tbody>${linesHtml}</tbody>
      </table>
      <div style="text-align:right;font-size:22px;font-weight:800;color:#0EA5E9;padding:14px;background:#E0F2FE;border-radius:8px;">${t.invoices.total}: $${parseFloat(est.total||0).toFixed(2)}</div>
      ${notesHtml}
      <div style="margin-top:40px;padding-top:20px;border-top:1px solid #eee;text-align:center;color:#999;font-size:11px;">Generated by BrilloPro · © 2025 Avanza One LLC. All rights reserved.</div>
    </body></html>`;
  win.document.write(html); win.document.close();
    ...
    <div style={{ minHeight:"100vh", background:C.black, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:24 }}>
      <div style={{ background:C.white, borderRadius:20, padding:36, maxWidth:380, width:"100%", textAlign:"center", boxShadow:"0 8px 40px rgba(14,165,233,0.2)", borderTop:`4px solid ${C.blue}` }}>
        ...
        <input
          ...
          style={{ width:"100%", padding:"12px 14px", borderRadius:10, border:`2px solid ${error ? C.red : C.grayMid}`, fontSize:15, marginBottom:12, boxSizing:"border-box", outline:"none", textAlign:"center", letterSpacing:2 }}
        />
...
function RouteTab({ t, clients }) {
  ...
  const loadTodaysRoute = () => {
    ...
    setStops(scheduled.map(c => ({ id:Date.now()+Math.random(), client:c.name, address:c.address, done:false, accessType:c.accessType, locationType:c.locationType })));
  };
  ...
  return (
    <div style={{ padding:16 }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
        <h2 style={{ margin:0, color:C.blue, fontSize:20, fontWeight:800 }}>{t.route.title}</h2>
      ...
      {stops.length === 0
        ...
        : stops.map((s, i) => (
          <div key={s.id} style={{ background:s.done?"#e2e8f0":C.white, borderRadius:12, padding:14, marginBottom:10, border:`1px solid ${C.grayMid}` }}>
            <div style={{ display:"flex", alignItems:"center", gap:12 }}>
              ...
              <div style={{ flex:1 }}>
                <div style={{ fontWeight:700, color:s.done?C.grayDark:C.text, textDecoration:s.done?"line-through":"none", fontSize:14 }}>
                  ...
                  {s.locationType ? <span style={{ marginLeft:6, fontSize:11, background:C.bluePale, color:C.blue, padding:"2px 6px", borderRadius:4 }}>{s.locationType}</span> : null}
                </div>
...
function ClientsTab({ t, clients, setClients }) {
  ...
  const scheduleLabel = (c) => {
    ...
    const days = (c.days||[]).map(d => t.clients.days[d]).join(", ");
    if (!days) return null;
  ...
  return (
    <div style={{ padding:16 }}>
      ...
      <div style={{ background:C.white, borderRadius:12, padding:16, marginBottom:16, border:`2px solid ${C.blue}` }}>
        <div style={{ fontSize:15, fontWeight:800, color:C.text, marginBottom:4 }}>⭐ {t.billing.reviewTitle}</div>
      ...
      {/* Payments */}
      <div style={{ background:C.white, borderRadius:12, padding:16, marginBottom:16, border:`2px solid ${C.blue}` }}>
        <div style={{ fontSize:15, fontWeight:800, color:C.text, marginBottom:4 }}>💳 {t.billing.paymentsTitle}</div>
      ...
      {/* Company settings */}
      <div style={{ background:C.white, borderRadius:12, padding:16, marginBottom:16, border:`2px solid ${C.blue}` }}>
        <div style={{ fontSize:15, fontWeight:800, color:C.text, marginBottom:14 }}>🏢 {t.billing.settings}</div>
        ...
        <button onClick={saveSettings} style={{ width:"100%", background:C.blue, color:C.white, border:"none", borderRadius:8, padding:"11px 0", fontWeight:700, cursor:"pointer", marginTop:6 }}>{t.billing.saveSettings}</button>
      ...
      <div style={{ background:C.bluePale, borderRadius:12, padding:16 }}>
        ...
        <div style={{ fontWeight:800, fontSize:16, color:C.blue, marginBottom:2 }}>{t.billing.monthly}</div>
  ...
  return (
    <div style={{ maxWidth:1100, margin:"0 auto", minHeight:"100vh", background:C.gray, fontFamily:"-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", paddingBottom:80 }}>
      ...
      <div style={{ background:C.black, position:"sticky", top:0, zIndex:10, borderBottom:`3px solid ${C.blue}` }}>
        <img src={brilloHeader} alt="BrilloPro" style={{ width:"100%", height:"auto", display:"block", maxHeight:"180px", objectFit:"cover" }} />
      ...
      <div style={{ position:"fixed", bottom:0, left:"50%", transform:"translateX(-50%)", width:"100%", maxWidth:1100, background:C.black, borderTop:`3px solid ${C.blue}`, zIndex:10 }}>
        <div style={{ display:"flex" }}>
          {t.tabs.map((tab, i) => (
            <button key={tab} onClick={() => setActiveTab(i)} style={{ flex:1, padding:"10px 0", background:"none", border:"none", color:activeTab===i?C.blue:"rgba(255,255,255,0.5)", fontWeight:activeTab===i?800:500, fontSize:11, cursor:"pointer", borderTop:activeTab===i?`2px solid ${C.blue}`:"2px solid transparent" }}>
              {TAB_ICONS[i]}<br />{tab}
            </button>
          ))}
        </div>
        <div style={{ textAlign:"center", color:"rgba(255,255,255,0.25)", fontSize:9, padding:"3px 0 5px", letterSpacing:0.3 }}>
